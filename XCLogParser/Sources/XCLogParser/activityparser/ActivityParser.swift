...
public class ActivityParser {
    ...
    public func parseIDEActivityLogSection(iterator: inout IndexingIterator<[Token]>) throws -> IDEActivityLogSection {
        ...
        default:
            subtitle = try parseAsString(token: nextToken)
        }
    ...
    let IDEActivityLogSectionClass = String(describing: IDEActivityLogSection.self)
    let DBGConsoleLogClass = String(describing: DBGConsoleLog.self)
    ...
    private func parseLogSection(iterator: inout IndexingIterator<[Token]>)
        ...
        if className == IDEActivityLogSectionClass {
        ...
        if className == DBGConsoleLogClass {
    ...
    private func parseAsString(token: Token?) throws -> Substring {
